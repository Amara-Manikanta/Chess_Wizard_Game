...
// Official Standard Staunton Chess Piece SVG Vectors (Ultra-clear, universally recognizable)
const PIECE_SVGS = {
  w: {
    ...
    b: `<svg viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g fill="#ffffff"><path d="M9 36c1.2-2.5 7-4 13.5-4 6.5 0 12.3 1.5 13.5 4H9z"/><path d="M15 32c2.5-2.5 12.5-2.5 15 0"/><path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/><path d="M17.5 26c-1.5-1.5-3-3-4.5-4.5-1.5-1.5-1-4 1.5-6.5 2.5-2.5 6.5-3 9.5-.5 3 2.5 2 6-1 9-1.5 1.5-4 3.5-5.5 2.5z"/></g><path d="M15 14l15 15M22.5 10v6M20 13h5M11.5 37c5.5-3 16.5-3 22 0"/></g></svg>`,
    n: `<svg viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10c1.05-3.3 6-2 6 3 1.5-1.5 4-1.5 5 1.5s-1.5 4.5-3 5.5c3 1.5 3 4.5 0 6-2.5 1.25-5.5 1-7.5-1.5 0 0-2.5 2.5-5.5 2.5s-4-2-4-2c-1 3-5 5-8 5 0-3 3-5 5-7 0 0-4-1.5-4-5.5 0-3 2-6 5-6 1 0 3 .5 3 1.5s1 1.5 2 1.5s2-1 2-3z" fill="#ffffff"/><path d="M9.5 25.5A.5.5 0 1 1 8.5 25.5A.5.5 0 1 1 9.5 25.5z" fill="#000"/><path d="M15 15.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" fill="#000"/><path d="M11.5 37c5.5-3 16.5-3 22 0"/></g></svg>`,
  ...
  b: {
    ...
    b: `<svg viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g fill="#1e2235"><path d="M9 36c1.2-2.5 7-4 13.5-4 6.5 0 12.3 1.5 13.5 4H9z"/><path d="M15 32c2.5-2.5 12.5-2.5 15 0"/><path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/><path d="M17.5 26c-1.5-1.5-3-3-4.5-4.5-1.5-1.5-1-4 1.5-6.5 2.5-2.5 6.5-3 9.5-.5 3 2.5 2 6-1 9-1.5 1.5-4 3.5-5.5 2.5z"/></g><path d="M15 14l15 15" stroke="#d4af37"/><path d="M22.5 10v6" stroke="#d4af37"/><path d="M20 13h5" stroke="#d4af37"/><path d="M11.5 37c5.5-3 16.5-3 22 0" stroke="#d4af37"/></g></svg>`,
    n: `<svg viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10c1.05-3.3 6-2 6 3 1.5-1.5 4-1.5 5 1.5s-1.5 4.5-3 5.5c3 1.5 3 4.5 0 6-2.5 1.25-5.5 1-7.5-1.5 0 0-2.5 2.5-5.5 2.5s-4-2-4-2c-1 3-5 5-8 5 0-3 3-5 5-7 0 0-4-1.5-4-5.5 0-3 2-6 5-6 1 0 3 .5 3 1.5s1 1.5 2 1.5s2-1 2-3z" fill="#1e2235"/><path d="M9.5 25.5A.5.5 0 1 1 8.5 25.5A.5.5 0 1 1 9.5 25.5z" fill="#d4af37"/><path d="M15 15.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" fill="#d4af37"/><path d="M11.5 37c5.5-3 16.5-3 22 0" stroke="#d4af37"/></g></svg>`,
